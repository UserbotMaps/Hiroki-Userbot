...
VEGETA_TEKS_KOSTUM = os.environ.get("HIRO_TEKS_KOSTUM") or "ㅤ"
...
HELP_LOGO = os.environ.get(
   "HELP_LOGO") or "https://telegra.ph/file/040c6a31ae08e75059ccf.jpg"

# Default .alive Instagram
IG_ALIVE = os.environ.get("IG_ALIVE") or "instagram.com/ismail.neey"
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**🔥Hiroshi-Userbot🔥 v{BOT_VER} Sedang berjalan!**\n\n"
...
with bot:
    try:
        ...
        async def handler(event):
            ...
            text = (
                f"**Hey**, __I am using__  **🔥Hiroshi-Userbot** \n\n"
                f"       __Thanks For Using me__\n\n"
                f"🔥 **Group Support :** [SUPPORT](t.me/hiroshisupport)\n"
                f"🔥 **OWNER :** [HIROSHI](t.me/Bisubiarenak)\n"
            ...
            await tgbot.send_file(
                ...
                buttons=[
                    [
                        custom.Button.url(
                            text="🔥 Repo Hiroshi-Userbot 🔥",
                            url="https://github.com/UserbotMaps/Hiroshi-Userbot",
                        )
                    ],
                    [
                        custom.Button.url(
                            text="GROUP", url="https://t.me/hiroshisupport"
                        ),
                        custom.Button.url(
                            text="CHANNEL", url="https://t.me/bombleebas"
                        ),
                    ],
                ],
            )
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@Ramubot"):
                ...
                result = builder.photo(
                    file=ramlogo,
                    link_preview=False,
                    text=f"**⚡ inline Hiroshi-Userbot ⚡**\n\n⚡ **Owner** [Hiroshi](t.me/Bisubiarenak)\n⚡ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
                ...
                result = builder.article(
                    ...
                    text="**🔥Hiroshi-Userbot🔥**\n➖➖➖➖➖➖➖➖➖➖\n⚡ **Owner :** [Hiroshi](https://t.me/Bisubiarenak)\n⚡ **Support :** @hiroshisupport\n⚡ **Repository :** [☣️Hiroshi-Userbot☣️](https://github.com/UserbotMaps/Hiroshi-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/hiroshisupport"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/UserbotMaps/Hiroshi-Userbot"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/bombleebas"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/UserbotMaps/Hiroshi-Userbot"
                            ),
                        ],
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@Ramubot"):
                ...
                result = builder.article(
                    " 🔥Hiroshi-Userbot🔥 ",
                    text="""**🔥Hiroshi-Userbot\n\n Anda Bisa Membuat Hiroshi Userbot Anda Sendiri Dengan Cara:** __TEKEN DIBAWAH INI!__ 👇""",
                    buttons=[
                        [
                            custom.Button.url(
                                "🔥Hiroshi-Userbot🔥",
